...
|De bestede tijd aan herstellen van problemen, tussen het moment waarop de developers aangeven dat het product klaar is om gereleased te worden en het moment dat het daadwerkelijk vrijgegeven kan worden. Ontwerp, de kwaliteit van het product, alsmede de robuustheid van het ontwikkelproces hebben hier directe invloed op. |The time spent correcting product problems between the point the developers say it is ready to release and the point where it is actually released to customers. This helps represent the impact of poor development practices and underlying design and code base.
